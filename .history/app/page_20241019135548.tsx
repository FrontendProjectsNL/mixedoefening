...
export default function Home() {
  return (
    ...
    // </div>
    <div>
      <section className="parallax-one flex items-center justify-center text-white skew">
      ...
      <section className="parallax-two flex items-center justify-center text-white skew">
      ...
      <section className="parallax-three flex items-center justify-center text-white skew">
