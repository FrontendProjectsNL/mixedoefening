...
const Hero: React.FC<PageProps> = () => {
  return (
    <div className="grid lg:grid-cols-3 z-20">
      <div className="flex flex-col col-span-1 lg:col-span-2 p-8  min-h-[500px] h-[500px] bg-slate-300 rounded-2xl">
        <h1 className="font-bold lg:text-4xl mt-6 text-3xl">Hello, Welcome!</h1>
        <p className="lg:text-3xl font-light mt-3 leading-snug lg:leading-normal text-xl">
        ...
        <div className="mt-auto lg:mb-14">
          <Link
