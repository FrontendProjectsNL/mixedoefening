...
const Section: React.FC<SectionProps> = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 md:px-8 bg-orange-200 rounded-2xl">
      <div className="col-span-1 lg:col-span1">
        <p>
          {' '}
      ...
      <div className="col-span1 lg:col-span2"></div>
    </div>
  );
};
