...
export default function Header() {
  ...
  return (
    <nav
      className={`fixed z-20 top-0 left-0 w-full transition-all duration-500 bg-gray-900 ${
        isShrunk ? 'h-16' : 'h-24'
      } flex items-center justify-between max-w-7xl mx-auto px-4`} // Change px-8 to px-4 for better responsiveness
    >
