...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Add throttling or debouncing here if necessary
      setIsShrunk(window.scrollY > 50); // Set to `true` if scrolled > 50px
    };
  ...
  return (
    <nav
      className={clsx(
        'fixed top-0 left-0 w-full transition-all duration-300 bg-gray-900 flex items-center justify-between px-8',
        {
          'h-12': isShrunk,
          'h-20': !isShrunk,
        }
